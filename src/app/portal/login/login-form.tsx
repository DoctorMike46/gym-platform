...
export default function PortalLoginForm({ primaryColor }: { primaryColor: string }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/portal/forgot-password" className="text-xs text-slate-500 hover:text-slate-700">
