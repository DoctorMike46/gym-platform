                ...
                <div className="min-h-[400px]">
                    ...
                    {view === 'files' && (
                        selectedClient && selectedFolder === 'foto_progresso' && viewMode === 'grid' ? (
                            ...
                            <>
                            {/* Desktop: tabella file */}
                            <div className="hidden md:block bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden overflow-x-auto animate-in fade-in slide-in-from-bottom-2 duration-300">
                            ...
                            {/* Mobile: card list file */}
                            <div className="md:hidden space-y-2 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                {filteredDocs.length === 0 ? (
                                    <div className="bg-white rounded-xl border border-slate-200 py-12 text-center">
                                        <Folder className="w-10 h-10 mx-auto mb-3 opacity-20 text-slate-400" />
                                        <p className="text-sm font-medium text-slate-500">
                                            Questa cartella è vuota
                                        </p>
                                        <p className="text-xs text-slate-400 mt-1">
                                            Inizia caricando un file per {selectedClient?.nome}.
                                        </p>
                                    </div>
                                ) : (
                                    filteredDocs.map((doc) => (
                                        ...
                                        >
                                            <div className="px-4 py-3 flex items-start gap-3">
                                                <div className="p-2 bg-slate-100 rounded-lg shrink-0">
                                                    {doc.tipo_documento === 'foto_progresso' ? (
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    ...
                                                    <div className="flex items-center gap-2 mt-1 text-[10px] text-slate-400">
                                                        ...
                                                        <span suppressHydrationWarning>
                                                            {new Date(
                                                                doc.data_documento || doc.created_at
                                                        ...
                                                        <span>·</span>
                                                        <span>{formatSize(doc.dimensione_bytes)}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="flex items-center border-t border-slate-100">
                                                <button
                                                    type="button"
                                                    onClick={() => handleDownload(doc.id)}
                                                    className="flex-1 px-3 py-2 text-xs font-semibold brand-text hover:bg-slate-50 flex items-center justify-center gap-1.5 transition-colors"
                                                >
