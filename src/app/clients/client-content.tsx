                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <div className="mt-1">
                                                {activeSub ? (
                                                    ...
                                                    <Badge
                                                        variant="outline"
                                                        className="text-slate-400 border-slate-200 shadow-none text-[10px]"
                                                    >
                                                        Nessun abbonamento
                                                    </Badge>
                                                )}
                                        ...
                                        <AlertDialog>
                                            <AlertDialogTrigger asChild>
                                                <button
                                                    ...
                                                    disabled={deletingId === client.id}
                                                    className="flex-1 px-3 py-2 text-xs font-semibold text-rose-600 hover:bg-rose-50 flex items-center justify-center gap-1.5 transition-colors disabled:opacity-50"
                                                >
                                                    <Trash2 size={13} />
                                                    Elimina
                                                </button>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        ...
                                                        ? L&apos;operazione è
                                                        irreversibile e rimuoverà anche
                                                        i suoi abbonamenti.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
